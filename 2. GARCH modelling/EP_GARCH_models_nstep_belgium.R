...
#### Importing the data ####
log_returns = read.csv("log_returns_belgium_new.csv", header = TRUE) #But it is Sweden!
...
plot(vec_egarch_std_24, type = 'l')

# Export tables!
write.table(EP_feature_matrix_1, "./1_EP/EP_features/Belgium/EP_feature_matrix_belgium_1.csv", sep = ",", row.names = FALSE, col.names = TRUE, quote = TRUE)
write.table(EP_feature_matrix_12, "./1_EP/EP_features/Belgium/EP_feature_matrix_belgium_12.csv", sep = ",", row.names = FALSE, col.names = TRUE, quote = TRUE)
write.table(EP_feature_matrix_24, "./1_EP/EP_features/Belgium/EP_feature_matrix_belgium_24.csv", sep = ",", row.names = FALSE, col.names = TRUE, quote = TRUE)
