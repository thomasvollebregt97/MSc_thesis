forecast_eval_ms_plus = function(distr, log_returns_train, log_returns_test){
  ...
  filt_var = filt_var[(length(log_returns_train)):(length(log_returns_train)+length(log_returns_test))]
